...
import { FeedbackPopupForm } from "./components/feedback/FeedbackPopupForm";
...
function App({ navbarComponent }: Props) {
  ...
  return (
    <div className="mt-2 dark:bg-black dark:text-white">
        ...
        {shouldShowBanner && (
          <div className="px-4 mb-2">
            <FeedbackBanner
              ...
              onClaimClick={() => setIsFeedbackPopupOpen(true)}
            />
          </div>
        )}
      ...
      <FeedbackFAB onClick={() => setIsFeedbackPopupOpen(true)} />

      <FeedbackPopupForm
        open={isFeedbackPopupOpen}
        onOpenChange={setIsFeedbackPopupOpen}
        onComplete={dismissBanner}
      />
    </div>
  );
}
