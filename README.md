...
The app has a React/Vite front end and a FastAPI backend. You will need an OpenAI API key to access the GPT-4 Vision API.
...
**Instagram page (with no Taylor Swift pics)**
