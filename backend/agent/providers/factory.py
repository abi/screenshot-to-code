...
def create_provider_session(
    ...
    if model in OPENAI_MODELS:
        ...
        client = AsyncOpenAI(api_key=openai_api_key, base_url=openai_base_url, timeout=60.0, max_retries=3)
    ...
    if model in ANTHROPIC_MODELS:
        ...
        client = AsyncAnthropic(api_key=anthropic_api_key, timeout=60.0, max_retries=3)
